...
final class Version20240402024501 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sylius_shipment ADD shipment_id VARCHAR(255) DEFAULT NULL, ADD rate_id VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sylius_shipment DROP shipment_id, DROP rate_id');
    }
}
