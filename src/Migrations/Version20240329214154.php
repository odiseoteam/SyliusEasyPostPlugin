...
final class Version20240329214154 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE odiseo_easy_post_configuration (id INT AUTO_INCREMENT NOT NULL, sender_data_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, api_key VARCHAR(255) NOT NULL, enabled TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_9F734EB4BA0367F7 (sender_data_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
